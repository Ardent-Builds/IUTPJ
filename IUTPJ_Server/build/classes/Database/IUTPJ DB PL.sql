...
CREATE TABLE SUBMISSION(
    ...
    RUNNING_TIME NUMBER(5) NOT NULL,
    CODE_FILE BLOB NOT NULL,
    FOREIGN KEY(PROBLEM_ID) REFERENCES PROBLEM_SET(ID),
...
CREATE TABLE CONTEST_PROBLEM_JUNCTION(
    ...
    PROBLEM_ID VARCHAR2(15) NOT NULL,
    FOREIGN KEY(CONTEST_ID) REFERENCES CONTEST_INFO(ID),
    FOREIGN KEY(PROBLEM_ID) REFERENCES PROBLEM_SET(ID),
...
CREATE OR REPLACE FUNCTION INSERT_SUBMISSION(
  ...
  ST IN SUBMISSION.SUBMISSION_TIME%TYPE,
...
BEGIN
  UNIQUE_ID := TO_CHAR(SYSDATE,'DDMMYYYYHH24MISS');
  INSERT INTO SUBMISSION VALUES(UNIQUE_ID, PID, USID, CL, ST, VR, RT, CDF);
  RETURN 'SUCCESS';
